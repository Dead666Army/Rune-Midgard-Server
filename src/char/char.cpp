...
int char_mmo_char_tosql(uint32 char_id, struct mmo_charstatus* p){
	...
	/* Player WoE Stadistics */
	if (memcmp(&p->woestats, &cp->woestats, sizeof(struct s_woe_stats)))
	{
		uint32 woe_date_year, woe_date_month, woe_date_day;
		time_t t;
		struct tm * lt;
		t = time(NULL);
		lt = localtime(&t);
		woe_date_year = lt->tm_year + 1900;
		woe_date_month = lt->tm_mon + 1;
		woe_date_day = lt->tm_mday;
		uint32 woe_date = woe_date_year * 10000 + woe_date_month * 100 + woe_date_day;

		if (SQL_ERROR == Sql_Query(sql_handle, "REPLACE INTO `char_woe` ("
			"`char_id`,`woe_date`,"
			"`top_damage`, `damage_done`, `damage_received`, emp_damage_done, "
			"`emperium_kill`, `kill_count`, `death_count`," 
			"`score`, `points`, `rank_points`,"
			"`sp_heal_potions`, `hp_heal_potions`, `yellow_gemstones`, `red_gemstones`, `blue_gemstones`, `poison_bottles`, `acid_demostration`,"
			...
			"'%u','%u','%u','%u','%d')",
			p->char_id, woe_date,
			p->woestats.top_damage, p->woestats.damage_done, p->woestats.damage_received, p->woestats.emp_damage_done,
			p->woestats.emperium_kill, p->woestats.kill_count, p->woestats.death_count, 
			p->woestats.score, p->woestats.points, p->woestats.rank_points,
			p->woestats.sp_heal_potions, p->woestats.hp_heal_potions, p->woestats.yellow_gemstones, p->woestats.red_gemstones, p->woestats.blue_gemstones, p->woestats.poison_bottles, p->woestats.acid_demostration,
			p->woestats.support_skills_used, p->woestats.healing_done, p->woestats.wrong_support_skills_used, p->woestats.wrong_healing_done,
			p->woestats.sp_used, p->woestats.zeny_used, p->woestats.spiritb_used, p->woestats.ammo_used, p->woestats.showstats))
		{
			Sql_ShowDebug(sql_handle);
			errors++;
		}
...
int char_mmo_char_fromsql(uint32 char_id, struct mmo_charstatus* p, bool load_everything) {
	...
	if (SQL_ERROR == SqlStmt_Prepare(stmt, "SELECT `top_damage`,`damage_done`,`damage_received`,`emp_damage_done`, `emperium_kill`, `kill_count`,`death_count`,`score`,`points`,`rank_points`,`sp_heal_potions`,`hp_heal_potions`,`yellow_gemstones`,`red_gemstones`,`blue_gemstones`,`poison_bottles`,`acid_demostration`, `support_skills_used`,`healing_done`,`wrong_support_skills_used`,`wrong_healing_done`, `sp_used`,`zeny_used`,`spiritb_used`,`ammo_used`,`showstats` FROM `char_woe` WHERE `char_id` = ? and `woe_date` = ?")
		|| SQL_ERROR == SqlStmt_BindParam(stmt, 0, SQLDT_INT, &char_id, 0)
		|| SQL_ERROR == SqlStmt_BindParam(stmt, 1, SQLDT_INT, (void*)&woe_date, sizeof(woe_date))
		|| SQL_ERROR == SqlStmt_Execute(stmt)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 0, SQLDT_UINT, &p->woestats.top_damage, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 1, SQLDT_UINT, &p->woestats.damage_done, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 2, SQLDT_UINT, &p->woestats.damage_received, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 3, SQLDT_UINT, &p->woestats.emp_damage_done, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 4, SQLDT_USHORT, &p->woestats.emperium_kill, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 5, SQLDT_USHORT, &p->woestats.kill_count, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 6, SQLDT_USHORT, &p->woestats.death_count, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 7, SQLDT_USHORT, &p->woestats.score, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 8, SQLDT_USHORT, &p->woestats.points, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 9, SQLDT_USHORT, &p->woestats.rank_points, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 10, SQLDT_UINT, &p->woestats.sp_heal_potions, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 11, SQLDT_UINT, &p->woestats.hp_heal_potions, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 12, SQLDT_UINT, &p->woestats.yellow_gemstones, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 13, SQLDT_UINT, &p->woestats.red_gemstones, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 14, SQLDT_UINT, &p->woestats.blue_gemstones, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 15, SQLDT_UINT, &p->woestats.poison_bottles, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 16, SQLDT_UINT, &p->woestats.acid_demostration, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 17, SQLDT_UINT, &p->woestats.support_skills_used, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 18, SQLDT_UINT, &p->woestats.healing_done, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 19, SQLDT_UINT, &p->woestats.wrong_support_skills_used, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 20, SQLDT_UINT, &p->woestats.wrong_healing_done, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 21, SQLDT_UINT, &p->woestats.sp_used, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 22, SQLDT_UINT, &p->woestats.zeny_used, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 23, SQLDT_UINT, &p->woestats.spiritb_used, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 24, SQLDT_UINT, &p->woestats.ammo_used, 0, NULL, NULL)
		|| SQL_ERROR == SqlStmt_BindColumn(stmt, 25, SQLDT_USHORT, &p->woestats.showstats, 0, NULL, NULL)
		|| SQL_SUCCESS != SqlStmt_NextRow(stmt))
	{
		p->woestats.score = 2000;
	}
...
enum e_char_del_response char_delete(struct char_session_data* sd, uint32 char_id){
	...
	// Delete records in char_woe table
	if (SQL_ERROR == Sql_Query(sql_handle, "DELETE FROM `char_woe` WHERE `char_id` = '%d'", char_id))
		Sql_ShowDebug(sql_handle);
