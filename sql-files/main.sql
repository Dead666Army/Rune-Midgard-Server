...
-- added standard accounts for servers, VERY INSECURE!!!
-- inserted into the table called login which is above
REPLACE INTO `login` (`account_id`, `userid`, `user_pass`, `sex`, `email`) VALUES ('1', 's1', 'p1', 'S','athena@athena.com');
...
--
-- Table structure for table `instance_timer`
--
...
--
-- Table structure for table `instance_team`
--
...
--
-- Table structure for table `cp_cmdjustification`
--

CREATE TABLE IF NOT EXISTS cp_cmdjustification (
 `cmdjustification_id` int(11) AUTO_INCREMENT,
 `atcommand_id` int(11) NOT NULL,
 `justification` varchar(50) NOT NULL,
 PRIMARY KEY (`cmdjustification_id`)
) ENGINE=MyISAM;
...
--
-- Table structure for table `char_woe`
--
